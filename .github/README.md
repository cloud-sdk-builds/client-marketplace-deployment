...
[`@aws-sdk/client-marketplace-deployment`](https://www.npmjs.com/package/@aws-sdk/client-marketplace-deployment/v/3.943.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-deployment@3.943.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-y7snWhzBpa8vcZ+YuDZTJPCzIX529nnuHTjmPMs5w0wZIUdpSVQOHghFQ1t0+EMM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-marketplace-deployment": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-deployment@3.943.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-deployment@3.943.0/index.min.mjs": "sha384-y7snWhzBpa8vcZ+YuDZTJPCzIX529nnuHTjmPMs5w0wZIUdpSVQOHghFQ1t0+EMM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-marketplace-deployment/blob/refs/tags/3.943.0/LICENSE
```
