...
[`@aws-sdk/client-marketplace-deployment`](https://www.npmjs.com/package/@aws-sdk/client-marketplace-deployment/v/3.554.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-deployment@3.554.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Xm1DQi1HdRRHZDgEhd1dyMLP+IrdD1slOvOYi4FOX+OfuNA1vPmIs++pS5HHnWZR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-marketplace-deployment": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-deployment@3.554.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-deployment@3.554.0/index.min.mjs": "sha384-Xm1DQi1HdRRHZDgEhd1dyMLP+IrdD1slOvOYi4FOX+OfuNA1vPmIs++pS5HHnWZR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-marketplace-deployment/blob/refs/tags/3.554.0/LICENSE
```
